...
dec6 = pd.read_csv('https://s3.eu-geo.objectstorage.softlayer.net/ml-datasetstore/coinmarketcap_06122017.csv')
print(dec6)
...
ax =cap10.plot.bar( y='market_cap_usd',logy=True,color=COLORS)
